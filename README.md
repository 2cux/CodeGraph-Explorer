...
```bash
# macOS / Linux
CODEGRAPH_VERSION=v1.0.0-rc.1 curl -fsSL https://raw.githubusercontent.com/2cux/CodeGraph-Explorer/main/install.sh | sh

# Windows PowerShell
$env:CODEGRAPH_VERSION="v1.0.0-rc.1"; irm https://raw.githubusercontent.com/2cux/CodeGraph-Explorer/main/install.ps1 | iex
```
