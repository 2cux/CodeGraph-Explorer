...
const STEPS: Step[] = [
  {
    ...
    target: "authenticate",
    path: "src/auth.py:42",
    reason: "Review entry point for login flow",
  },
  {
    action: "READ",
    target: "verify_token",
    path: "src/auth.py:104",
    reason: "Understand token validation logic",
  },
  {
    action: "READ",
    target: "MFAForm",
    path: "src/ui/mfa.tsx:18",
    reason: "MFA implementation details",
  },
  {
    action: "READ",
    target: "test_auth_mfa",
    path: "tests/test_auth.py:31",
    reason: "Verify MFA integration",
  },
];
    ...
    <li
      ...
      style={{
        ...
        background: isActive
          ...
          : hovered
          ? "color-mix(in srgb, var(--cg-text-primary) 3%, transparent)"
          : "transparent",
        borderLeft: isActive
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <span
            ...
            style={{
              fontSize: 9,
              fontWeight: 500,
              color: ACTION_COLOR[step.action],
